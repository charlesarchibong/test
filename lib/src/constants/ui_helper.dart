...
class UiHelper {
  ...
  /// This method is used to get a mapped (proportional) height given a specific height from the design.
  ...
  Widget verticalSpace(double size) {
    return SizedBox(height: getMappedHeight(size));
  }

  Widget horizontalSpace(double size) {
    return SizedBox(width: getMappedWidth(size));
  }
}
